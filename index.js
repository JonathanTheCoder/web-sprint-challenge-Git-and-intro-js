...
function removeArtist(array, number) {
  ...
  let remove = []
 for(let i = 0; i < array.length; i+= 1){
  const currentObject2 = array[i]
  remove.pop(currentObject2.id)
}
return remove
}
...
function addArtist(array,name,years,genre,nationality,bio){
  ...
  const artistAdd = {
      ...
      bio: 'Love Computers.',
   dataArray.push('Jonathan Lugo');
    }

    return artistAdd
}
console.log(addArtist(artists, 'Jonathan Lugo', '2003-2022','Web Design', 'Dominican', 'Love Computers.'))
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 7: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
